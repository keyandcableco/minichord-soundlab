...
const PARAM_GROUPS = [
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    domain: "chord",
    title: "General",
    blurb: "Voice-wide settings for the chord section: its octave, the chord voicing pattern, and how it glides between chords.",
    params: [
      ...
      { addr: 120, name: "Chord voicing", card: "Voicing & glide", unit: "", min: 0, max: 5, step: 1, type: "int", curve: "linear", def: 2,
        options: ["Normal", "Octave up · voicing 1", "Octave up · voicing 2", "Octave up · voicing 3", "Octave up · voicing 4", "Two octaves up"],
        optionNotes: [
          "The standard chord layout.",
          "One octave up, with one set of added notes.",
          "One octave up, with a different set of added notes.",
          "One octave up, with another set of added notes.",
          "One octave up, with a fuller set of added notes.",
          "Two octaves up: bright and open.",
        ],
        explain: { is: "The chord voicing pattern, how the notes are laid out and which extras are added.", does: "Moves the chord up an octave or two and changes which extra notes are added.", tips: "Experiment to find the voicing that sits best against the harp and the song." } },
