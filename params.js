...
const PARAM_GROUPS = [
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    params: [
      { addr: 202, name: "Alt layout maj", card: "Chord layout", unit: "", min: 0, max: 29, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad", "Just augmented", "Supermajor 7"],
        explain: { is: "Which chord the major button plays in the alternate layout.", does: "Points that button combination at any of the twenty-nine chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. The just augmented and the supermajor 7 come last, after the hexad, so the numbers before them keep their meaning: in twelve they sound as the augmented and the major 7. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 203, name: "Alt layout min", card: "Chord layout", unit: "", min: 0, max: 29, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad", "Just augmented", "Supermajor 7"],
        explain: { is: "Which chord the minor button plays in the alternate layout.", does: "Points that button combination at any of the twenty-nine chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. The just augmented and the supermajor 7 come last, after the hexad, so the numbers before them keep their meaning: in twelve they sound as the augmented and the major 7. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 204, name: "Alt layout 7th", card: "Chord layout", unit: "", min: 0, max: 29, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad", "Just augmented", "Supermajor 7"],
        explain: { is: "Which chord the seventh button plays in the alternate layout.", does: "Points that button combination at any of the twenty-nine chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. The just augmented and the supermajor 7 come last, after the hexad, so the numbers before them keep their meaning: in twelve they sound as the augmented and the major 7. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 205, name: "Alt layout maj+7th", card: "Chord layout", unit: "", min: 0, max: 29, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad", "Just augmented", "Supermajor 7"],
        explain: { is: "Which chord major and seventh together plays in the alternate layout.", does: "Points that button combination at any of the twenty-nine chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. The just augmented and the supermajor 7 come last, after the hexad, so the numbers before them keep their meaning: in twelve they sound as the augmented and the major 7. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 206, name: "Alt layout min+7th", card: "Chord layout", unit: "", min: 0, max: 29, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad", "Just augmented", "Supermajor 7"],
        explain: { is: "Which chord minor and seventh together plays in the alternate layout.", does: "Points that button combination at any of the twenty-nine chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. The just augmented and the supermajor 7 come last, after the hexad, so the numbers before them keep their meaning: in twelve they sound as the augmented and the major 7. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 207, name: "Alt layout maj+min", card: "Chord layout", unit: "", min: 0, max: 29, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad", "Just augmented", "Supermajor 7"],
        explain: { is: "Which chord major and minor together plays in the alternate layout.", does: "Points that button combination at any of the twenty-nine chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. The just augmented and the supermajor 7 come last, after the hexad, so the numbers before them keep their meaning: in twelve they sound as the augmented and the major 7. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 208, name: "Alt layout all three", card: "Chord layout", unit: "", min: 0, max: 29, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad", "Just augmented", "Supermajor 7"],
        explain: { is: "Which chord all three buttons plays in the alternate layout.", does: "Points that button combination at any of the twenty-nine chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. The just augmented and the supermajor 7 come last, after the hexad, so the numbers before them keep their meaning: in twelve they sound as the augmented and the major 7. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    params: [
      ...
      { addr: 111, name: "Voice leading", card: "Scale & harmony", unit: "", min: 0, max: 2, step: 1, type: "int", curve: "linear", def: 0, segmented: true,
        ...
        optionNotes: [
          ...
          "As On, but it also steers clear of parallel fifths and octaves, and of the outer voices leaping into a fifth or octave, taking a little more movement to do it. Slash voice's bass and re-voice follow the same rule.",
        ],
        explain: { is: "Whether chords move smoothly from one to the next.", does: "Keeps each chord's notes but chooses their octaves so the four voices travel as little as possible from the previous chord. Overrides inversion and spacing while it is on. Strict adds the classical rule against parallel fifths and octaves: a parallel costs as much as four semitones of movement, so it is avoided when a nearby alternative exists and accepted when none does.", tips: "A slash chord is led too, with its bass kept on the note it names: the bass takes the octave nearest the chord already sounding and the voices above it are led. With nothing sounding, a chord starts from root position. The Play mirror reads a led chord by its notes rather than its octaves." } },
