...
const PARAM_GROUPS = [
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    params: [
      { addr: 202, name: "Alt layout maj", card: "Chord layout", unit: "", min: 0, max: 27, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad"],
        explain: { is: "Which chord the major button plays in the alternate layout.", does: "Points that button combination at any of the twenty-seven chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 203, name: "Alt layout min", card: "Chord layout", unit: "", min: 0, max: 27, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad"],
        explain: { is: "Which chord the minor button plays in the alternate layout.", does: "Points that button combination at any of the twenty-seven chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 204, name: "Alt layout 7th", card: "Chord layout", unit: "", min: 0, max: 27, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad"],
        explain: { is: "Which chord the seventh button plays in the alternate layout.", does: "Points that button combination at any of the twenty-seven chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 205, name: "Alt layout maj+7th", card: "Chord layout", unit: "", min: 0, max: 27, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad"],
        explain: { is: "Which chord major and seventh together plays in the alternate layout.", does: "Points that button combination at any of the twenty-seven chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 206, name: "Alt layout min+7th", card: "Chord layout", unit: "", min: 0, max: 27, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad"],
        explain: { is: "Which chord minor and seventh together plays in the alternate layout.", does: "Points that button combination at any of the twenty-seven chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 207, name: "Alt layout maj+min", card: "Chord layout", unit: "", min: 0, max: 27, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad"],
        explain: { is: "Which chord major and minor together plays in the alternate layout.", does: "Points that button combination at any of the twenty-seven chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
      { addr: 208, name: "Alt layout all three", card: "Chord layout", unit: "", min: 0, max: 27, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Supermajor", "Subminor", "Neutral", "Harmonic 7", "Neutral 7", "Subminor 7", "Utonal tetrad", "Harmonic 9", "Otonal hexad"],
        explain: { is: "Which chord all three buttons plays in the alternate layout.", does: "Points that button combination at any of the twenty-seven chord types the instrument knows. Past 6/9 come the just chords, built from ratios for 19- and 31-EDO and listed in the order of their twelve-note counterparts. In twelve most of them sound as a chord already on the list: the subminor 7 plays an m7, the utonal tetrad an m7\u266d5.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better. The neutral chords are only themselves in 31: nineteen has no neutral third and rounds it onto the major. The harmonic 9 and the otonal hexad have more tones than the four voices, so the rhythm and the harp play the rest. A slot saved at 19 or above before this ordering now plays a different chord from the same family." } },
