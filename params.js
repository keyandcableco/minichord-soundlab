  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    params: [
      ...
      { addr: 237, name: "Temperament", card: "Scale & harmony", unit: "", min: 0, max: 11, step: 1,
        type: "int", curve: "linear", def: 0,
        options: ["Equal", "Meantone", "Just", "Pythagorean", "19-EDO", "31-EDO", "Werckmeister III", "Kirnberger III", "Vallotti", "Young", "Kellner", "1/6 Meantone"],
        optionNotes: [
          ...
          "Quarter-comma meantone, what most Renaissance and early Baroque music was written for. Major thirds are pure, fifths pay for it at 5.4 cents flat, and the wolf sits between G# and Eb: Bb through E major are sweet, while B, F#, Db and Ab major are unusable — which is why that music stays near home.",
