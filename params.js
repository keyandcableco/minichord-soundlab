...
const PARAM_GROUPS = [
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    params: [
      { addr: 202, name: "Alt layout maj", card: "Chord layout", unit: "", min: 0, max: 22, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Neutral", "Harmonic 7", "Subminor", "Supermajor"],
      ...
      { addr: 203, name: "Alt layout min", card: "Chord layout", unit: "", min: 0, max: 22, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Neutral", "Harmonic 7", "Subminor", "Supermajor"],
      ...
      { addr: 204, name: "Alt layout 7th", card: "Chord layout", unit: "", min: 0, max: 22, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Neutral", "Harmonic 7", "Subminor", "Supermajor"],
      ...
      { addr: 205, name: "Alt layout maj+7th", card: "Chord layout", unit: "", min: 0, max: 22, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Neutral", "Harmonic 7", "Subminor", "Supermajor"],
      ...
      { addr: 206, name: "Alt layout min+7th", card: "Chord layout", unit: "", min: 0, max: 22, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Neutral", "Harmonic 7", "Subminor", "Supermajor"],
        explain: { is: "Which chord minor and seventh together plays in the alternate layout.", does: "Points that button combination at any of the eighteen chord types the instrument knows.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better." } },
      { addr: 207, name: "Alt layout maj+min", card: "Chord layout", unit: "", min: 0, max: 22, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Neutral", "Harmonic 7", "Subminor", "Supermajor"],
        explain: { is: "Which chord major and minor together plays in the alternate layout.", does: "Points that button combination at any of the eighteen chord types the instrument knows.", tips: "Only has an effect when chord layout is set to Alternate. Default gives this slot its built-in chord \u2014 the seven together make up the suspended and extended set. Use the others to reach chords the standard set does not have, or just to move a chord to a button that suits your hand better." } },
      { addr: 208, name: "Alt layout all three", card: "Chord layout", unit: "", min: 0, max: 22, step: 1, type: "int", curve: "linear", def: 0,
        options: ["Default", "Major", "Minor", "Dominant 7", "Major 7", "Minor 7", "Diminished", "Augmented", "Major 6", "Minor 6", "Full diminished", "m7\u266d5", "sus4", "sus2", "7sus4", "maj9", "min9", "add9", "6/9", "Neutral", "Harmonic 7", "Subminor", "Supermajor"],
  ...
  /* ---------------------------------------------------------------------- */
  {
    ...
    params: [
      ...
      { addr: 237, name: "Temperament", card: "Scale & harmony", unit: "", min: 0, max: 5, step: 1,
        type: "int", curve: "linear", def: 0, segmented: true,
        options: ["Equal", "Meantone", "Just", "Pythagorean", "19-EDO", "31-EDO"],
        optionNotes: [
          "Twelve identical steps. Every key sounds the same and no interval is quite in tune — a major third is 13.7 cents sharp, which is the faint beating you hear in a piano chord.",
          "Quarter-comma meantone, what most Renaissance and early Baroque music was written for. Major thirds are pure. Fifths pay for it, 5.4 cents flat, and keys far from C get progressively stranger — which is why that music stays near home.",
          "Five-limit just intonation for C major. Thirds and fifths dead in tune in the home key, noticeably out in others.",
          "Pure 3:2 fifths all the way round. Bright, wide thirds at 21.5 cents sharp. Right for medieval music, wrong for most of what came after.",
        ...
        explain: { is: "How the octave is divided and tuned.",
          does: "Sets the pitch of every note. The first four keep twelve notes and nudge each by a few cents; the last two divide the octave into more than twelve, so sharps and flats stop being the same pitch.",
          tips: "Hold a major chord and switch Equal to Meantone \u2014 the third stops beating. All of them are anchored on C, so the unequal tunings sound progressively stranger the further you play from it, which is why the music written for them stays near home." } },
