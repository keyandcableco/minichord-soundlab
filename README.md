...
| `json/`, `fonts/` | preset data, the bundled typeface, and the staff's accidental font (a subset of Bravura) |
...
The staff's accidental font in `fonts/` is a subset of Steinberg's [Bravura](https://github.com/steinbergmedia/bravura),
renamed as its licence requires, and is under the [SIL Open Font License 1.1](fonts/OFL-soundlab-accidentals.txt),
not the license above. `fonts/subset-accidentals.py` rebuilds it.
