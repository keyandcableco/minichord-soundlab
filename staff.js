...
(function (window) {
  ...
  //
  // The sharp/flat modifier deliberately does NOT come into this. It says which
  // way a button moves a chord while it is HELD, not how to name the roots the
  // key signature produced. The staff draws a key signature and its noteheads
  // have to agree with it: three sharps in the signature and a G# drawn as A♭ is
  // not notation anyone can read.
